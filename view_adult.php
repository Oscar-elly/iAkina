...
<body>
    <div class="container">
        <h1 class="text-center my-4">Adult Details</h1>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['id'])) {
            ...
            $sql = "SELECT * FROM person WHERE id = $adult_id";
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<button class='btn btn-secondary mt-3' onclick=\"window.location.href='./view_adults.php'\">Back</button>";
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="delete_picture.php?id=<?php echo $adult_id; ?>" class="btn btn-danger">Delete</a>
                    </div>
                </div>
            </div>
        </div>
